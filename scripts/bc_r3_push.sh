...
PYTHON_CMD="conda activate dail && python train.py --algo ddpg --agent_type bc --save_expert_dir ./target_expert/reacher3_push/demo200_seed_${i} --load_dataset_dir ./target_demo/reacher3_push --edomain reacher3_push --ldomain reacher2_push --seed 100${i} --doc r3_push_bc_${i} --n_demo 200 --gpu ${gpu_num}"
