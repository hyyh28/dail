...
PYTHON_CMD="source ${VENV_DIR} && python train.py --algo ddpg --agent_type bc --save_expert_dir ./target_expert/reacher2_corner/demo1000_seed_${i} --load_dataset_dir ./target_demo/reacher2_corner --edomain reacher2_corner --ldomain reacher2_act_corner --seed 100${i} --doc r2_corner_bc_${i} --n_demo 1000 --gpu ${gpu_num}"
